...
import { faSearch, faUser, faChevronDown, faQuestionCircle, faShoppingCart, faBars, faArrowUp, faHeart, faComment } from '@fortawesome/free-regular-svg-icons'
...
<input type="text" placeholder="Search products, brands and categories" className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:border-accent"/>
</div>
<button className="bg-accent text-white px-6 rounded-r-lg">Search</button>
</div>
</div>
<div className="flex items-center space-x-6">
<div className="relative">
<button 
className={`flex items-center space-x-1 px-3 py-2 rounded ${accountDropdown ? 'bg-[#dcd6d2]' : 'hover:text-accent'}`}
...
<button className="w-full bg-accent text-white font-semibold py-2 rounded shadow text-center">SIGN IN</button>
</div>
<div className="py-1">
<a href="#" className="block px-4 py-2 hover:bg-gray-100 text-sm font-normal">
...
<div className="relative">
<button 
className={`flex items-center space-x-1 px-3 py-2 rounded ${helpDropdown ? 'bg-[#dcd6d2]' : 'hover:text-accent'}`}
...
<button className="w-full bg-accent text-white font-semibold py-2 rounded shadow text-center">
...
<div className="fixed inset-0 bg-black bg-opacity-50" onClick={() => setMobileMenu(false)}></div>
...
<div>
<a href="/">
<img src="https://res.cloudinary.com/dqhawdcol/image/upload/v1760977432/llxnbmi0whu8tnid5jdu.png" alt="Jumia" className="h-10 filter brightness-0 invert"/>
</a>
</div>
<div>
...
<div className="text-center text-xs grid grid-cols-2 gap-2 px-4 uppercase">
...
<div className="border-t border-gray-600 my-4 mx-4"></div>
